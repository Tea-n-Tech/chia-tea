...
from ...protobuf.generated.hardware_pb2 import CpuInfo, DiskInfo, RamInfo
...
async def collect_cpu_info() -> CpuInfo:
...
@log_runtime_async(__file__)
async def collect_ram_info() -> RamInfo:
...
@log_runtime_async(__file__)
async def collect_disk_info() -> List[DiskInfo]:
    """ Collect all about the disks

    Returns
    -------
    disk_info_list : List[DiskInfo]
