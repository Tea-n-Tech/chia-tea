...
class TestConfigCmd(unittest.TestCase):
    def test_config_init_creates_default_config_correctly(self):
        with patch("chia_tea.cli.config.create_default_config") as create_default_config_mock:
    ...
    def test_config_init_creates_custom_config_correctly(self):
        with patch("chia_tea.cli.config.create_default_config") as create_default_config_mock:
    ...
    def test_config_init_handles_an_existing_file_correctly(self):
        with patch("chia_tea.cli.config.create_default_config") as create_default_config_mock:
    ...
    def test_config_init_would_overwrite_if_asked(self):
        with patch("chia_tea.cli.config.create_default_config") as create_default_config_mock:
            result = runner.invoke(
                app,
